...
<div class="bg-pic"><img width="100%" src="<?php echo $homeurl.'/'.$setting['background_siswa'];?>" height='40px'> <alt="" class="lazy"> <div class="bg-caption pull-bottom text-white p-l-md"><h2 class="semi-bold">

             </p></div></div> <div class="login-container white" style="min-height: 600px;">
			<div class="m-x-sm m-t-sm" ><div class="p-x-sm p-y-xs pull-left btn btn-primary btn-sm"><i class='fa fa-calendar'></i> <?php echo $hari."&nbsp;" ; echo date('d'). "&nbsp;&nbsp;"; echo $bln."&nbsp;" ; echo date('Y'); ?></div><div class="p-x-sm p-y-xs pull-right btn btn-danger btn-sm" ><i class='fa fa-clock-o' ></i> <span class="" id="clock"></div></div > <div class=" p-x-md m-t-lg">
			<br>
	  ...
	  <input type="checkbox" id="show_password" value="1"><i class="primary"></i> Tampilkan Password
          </label></div> <button type="submit" class="btn blue p-l-md p-r-md btn-block p-x-md">LOGIN</button> 
