	...
	echo "
		...
		<html>
			<head>
				...
				<link rel='stylesheet' href='$homeurl/dist/css/Ad.min.css'/>
								...
								<div class='row'>
									<div class='col-md-12'>
										<div class='box box-solid'>
											...
											<tr><th >Nama</th><td width='10'>:</td><td>$siswa[nama]</td><td rowspan='3' width='150' align='center' style='font-size:80px'><font color='blue'>$nilai[skor]</font></td></tr>
								...
								<div class='row'>
									<div class='col-md-12'>
										<div class='box box-solid'>
											...
											<table class='table table-bordered table-striped'> 
											<tr><th width='150'>No Induk</th><td width='10'>:</td><td>$siswa[nis]</td><td width='150' align='center'>Nilai</td></tr>
											<tr><th >Nama</th><td width='10'>:</td><td>$siswa[nama]</td><td rowspan='3' width='150' align='center' style='font-size:80px'><font color='blue'>$nilai[skor]</font></td></tr>											<tr><th >Kelas</th><td width='10'>:</td><td>$siswa[id_kelas]</td></tr>
											<tr><th >Mata Pelajaran</th><td width='10'>:</td><td>$namamapel[nama_mapel]</td></tr>
											</table><br>
												<table id='example1' class='table table-bordered table-striped'>
													<thead>
