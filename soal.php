						...
						<table  width='100%' class='table table-striped table-hover'>
																	<tr>
																		...
																		if(in_array($ext,$image)) {																			
																			...
																			echo "<img src='$homeurl/files/$soal[$fileAA]' class='img-responsive' style='width:250px;'></a>";
																		}
																		elseif(in_array($ext,$audio)) {
																	...
																	<tr>
																		...
																		if(in_array($ext,$image)) {
																			...
																			echo "<img src='$homeurl/files/$soal[$fileBB]' class='img-responsive' style='width:250px;'></a>";
																	...
																	<tr>
																		...
																		if(in_array($ext,$image)) {
																			...
																			echo "<img src='$homeurl/files/$soal[$fileCC]' class='img-responsive' style='width:250px;'></a>";
																		}
																		elseif(in_array($ext,$audio)) {
																	...
																	<tr>
																		...
																		if(in_array($ext,$image)) {
																			...
																			echo "<img src='$homeurl/files/$soal[$fileDD]' class='img-responsive' style='width:250px;'></a>";
																		}
																		elseif(in_array($ext,$audio)) {
																	...
																	<tr>
																		...
																		if(in_array($ext,$image)) {
																			...
																			echo "<img src='$homeurl/files/$soal[$fileEE]' class='img-responsive' style='width:250px;'></a>";
																		}
																		elseif(in_array($ext,$audio)) {
				...
				<div class='col-md-12'>";
						if($soalesai['file']<>'') {
							...
							if(in_array($ext,$image)) {
								...
								echo "<a href='#'  data-toggle='modal' data-target='#myModalE'>";
								echo "<img src='$homeurl/files/$soalesai[file]' class='img-responsive'></a>";
							}
							elseif(in_array($ext,$audio)) {
...
<div class='panel panel-default'>
                ...
                <div class='panel-body'>
                    <div class='inner-content'>
                        <div class='row' style='background-color:#fff'>
							<img src='$homeurl/files/$soalesai[file]' class='img-responsive'>
                        </div>
                    </div>
                </div>
                <div class='panel-footer'>
